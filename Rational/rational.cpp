...
bool Rational::operator==(const Rational& rhs) const {
    return (this->num_ == rhs.num_ && this->denum_ == rhs.denum_);
}
bool Rational::operator!=(const Rational& rhs) const {
    return !this->operator==(rhs);
}
...
Rational Rational::operator-() const { return Rational{-num_, denum_}; }
...
int Rational::NOK(int a, int b) { return a * b / NOD(a, b); }
