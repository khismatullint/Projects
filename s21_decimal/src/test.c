...
START_TEST(test_s21_is_greater_03) {
  ...
  s21_decimal dec2 = {{0x48668fc0, 0x00000001, 0x00000000, 0x000F0000}};
  int s21_ret = s21_is_greater(dec1, dec2);
  int expected_ret = 1;
  ck_assert_int_eq(s21_ret, expected_ret);
}
...
START_TEST(test_s21_is_equal_4) {
  s21_decimal dec1 = {{0x10000000, 0x00000000, 0x00000000, 0x000F0000}};
  s21_decimal dec2 = {{0x10000000, 0x00000000, 0x00000000, 0x00000000}};
...
START_TEST(test_s21_is_equal_5) {
  s21_decimal dec1 = {{0x00000000, 0x00000000, 0x00000000, 0x000F0000}};
  s21_decimal dec2 = {{0x00000000, 0x00000000, 0x00000000, 0x00000000}};
...
START_TEST(s21_is_greater_or_equal_05) {
  s21_decimal value_1 = {{0x10000000, 0x00000000, 0x00000000, 0x000F0000}};
  s21_decimal value_2 = {{0x10000000, 0x00000000, 0x00000000, 0x00000000}};
  int s21_ret = s21_is_greater_or_equal(value_1, value_2);
  int expected_ret = 0;
  ck_assert_int_eq(s21_ret, expected_ret);
}
...
Suite *s21_is_greater_or_equal_suite(void) {
  ...
  tcase_add_test(tc_core, s21_is_greater_or_equal_05);
  suite_add_tcase(s, tc_core);
...
START_TEST(s21_is_less_05) {
  s21_decimal dec1 = {{0x48668fc0, 0x00000001, 0x00000000, 0x000a0000}};
  s21_decimal dec2 = {{0x48668fc0, 0x00000001, 0x00000000, 0x000F0000}};
  int s21_ret = s21_is_less(dec1, dec2);
  int expected_ret = 0;
  ck_assert_int_eq(s21_ret, expected_ret);
}
END_TEST
...
Suite *s21_is_less_suite(void) {
  ...
  tcase_add_test(tc_core, s21_is_less_05);
  suite_add_tcase(s, tc_core);
...
START_TEST(s21_div_8) {
  s21_decimal src1 = {{3, 0, 0, 0}}, src2 = {{0, 0, 0, 0}},
              result = {{0, 0, 0, 0}};
...
START_TEST(s21_div_10) {
  s21_decimal src1, src2, result = {{0, 0, 0, 0}};
  float a = -115.2;
  float b = 0.0;
...
int main() {
  int number_failed = 0;
  Suite *decimal_tests[] = {s21_is_less_suite(),              // +
